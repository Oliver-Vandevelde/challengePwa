...
const cacheName = 'www.test.oliver-vandevelde.be-superpwa-2.0.2';
const startPage = 'https://www.test.oliver-vandevelde.be';
const offlinePage = 'https://www.test.oliver-vandevelde.be';
